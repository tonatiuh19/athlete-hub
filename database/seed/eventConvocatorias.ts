/**
 * Rich HTML convocatorias + hero/banner images for mock events.
 * Source of truth for database/migrations/20260609_140000_event_convocatorias_rich_html.sql
 */

export interface EventConvocatoriaSeed {
  slug: string;
  heroImageUrl: string;
...
export const EVENT_CONVOCATORIA_SEEDS: EventConvocatoriaSeed[] = [
  {
    slug: "maraton-cdmx-2026",
    heroImageUrl: IMG("1452626212852-811d58933cae"),
    bannerImageUrl: IMG("1552674605-db6ffd4facb5", 1600),
    descriptionHtml: `
<p>La <strong>Gran Carrera Urbana 42K 2026</strong> es una carrera en ciudad con circuito certificado, cronometraje por chip y experiencia pensada para debutantes y fondistas experimentados.</p>
...
`.trim(),
  },
  {
    ...
    heroImageUrl: IMG("1476480862126-209bfaa8edc8"),
    bannerImageUrl: IMG("1551632811-561732d1e306", 1600),
    descriptionHtml: `
<p>El <strong>Desafío Trail Alto 2026</strong> es una carrera de montaña con terreno técnico, gran desnivel y dos distancias para distintos niveles de experiencia.</p>
<h2>Distancias</h2>
<ul>
...
`.trim(),
  ...
  {
    slug: "triatlon-acapulco-2026",
    heroImageUrl: IMG("1530549387789-4c1017266635"),
    bannerImageUrl: IMG("1544551763-46a013bb70d5", 1600),
    descriptionHtml: `
<p>El <strong>Triatlón Sprint &amp; Olímpico 2026</strong> combina natación en aguas abiertas, ciclismo y carrera en un formato clásico para atletas de todos los niveles.</p>
<h2>Formatos</h2>
<ul>
...
`.trim(),
  ...
  {
    slug: "carrera-10k-polanco-2026",
    heroImageUrl: IMG("1544551763-46a013bb70d5"),
    bannerImageUrl: IMG("1552674605-db6ffd4facb5", 1600),
    descriptionHtml: `
<p>La <strong>10K Nocturna 2026</strong> es una carrera urbana al atardecer: diez kilómetros con ambiente festivo, música en vivo y circuito iluminado.</p>
<h2>Formato</h2>
<ul>
...
`.trim(),
  ...
  {
    slug: "hyrox-mexico-city-2025",
    heroImageUrl: IMG("1571019614242-c5c5dee9f50b"),
    bannerImageUrl: IMG("1486218119243-13883505764c", 1600),
    descriptionHtml: `
<p>El <strong>Desafío Híbrido 2025</strong> combinó carreras de 1 km intercaladas con estaciones funcionales. Este evento ya concluyó; los resultados oficiales están publicados en la plataforma.</p>
