...
CREATE TABLE `organizers` (
  ...
  `payout_rail` enum('stripe','mercadopago') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'stripe' COMMENT 'Preferred checkout/payout rail',
  `mp_user_id` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mp_access_token_enc` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mp_refresh_token_enc` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mp_token_expires_at` datetime DEFAULT NULL,
  `mp_public_key` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mp_oauth_status` enum('not_started','pending','ready','revoked','error') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'not_started',
  `mp_oauth_connected_at` datetime DEFAULT NULL,
  `mp_oauth_last_synced_at` datetime DEFAULT NULL,
...
CREATE TABLE `payment_refunds` (
  ...
  `provider` enum('stripe','mock','mercadopago') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'stripe',
